...
int switch_routes_by_index(int route_1_index, int route_index_2, struct logbook *current_logbook);
...
//      state                - 1: success
//                            -1: failed  
int switch_routes_by_index(int route_1_index, int route_2_index, struct logbook *current_logbook) {
...
void command_s(struct logbook *current_logbook) {
    ...
    if(route_1_index == -1) {
        ...
        if(switch_routes_by_index(route_1_index, route_2_index, current_logbook) == 1) {
